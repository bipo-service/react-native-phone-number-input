...
export default class PhoneInput extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      code: !!props.code ? props.code : props.defaultCode ? undefined : "65",
      number: props.value
        ? props.value
        : props.defaultValue
        ? props.defaultValue
        : "",
      modalVisible: false,
      countryCode: props.defaultCode ? props.defaultCode : "SG",
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (!!nextProps.code && nextProps.code !== prevState.code)
  ...
  onChangeText = (text) => {
    ...
    console.log('onchangetext', text, onChangeFormattedText)
    if (onChangeFormattedText) {
